      ...
      <div class="header">
        ...
        return `
            <a href="${vHref('full', '#')}"
               ...
               data-variant="full"
               ${vTarget('full')}
               title="글로벌${SITE_VARIANT === 'full' ? ' (현재)' : ''}">
              <span class="variant-icon">🌍</span>
              <span class="variant-label">글로벌</span>
            </a>
            ...
            <a href="${vHref('tech', '#')}"
               ...
               data-variant="tech"
               ${vTarget('tech')}
               title="기술${SITE_VARIANT === 'tech' ? ' (현재)' : ''}">
              <span class="variant-icon">💻</span>
              <span class="variant-label">기술</span>
            </a>
            <span class="variant-divider"></span>
            <a href="${vHref('finance', '#')}"
               ...
               ${vTarget('finance')}
               title="금융${SITE_VARIANT === 'finance' ? ' (현재)' : ''}">
              <span class="variant-icon">📈</span>
              <span class="variant-label">금융</span>
            </a>
            ...
            <a href="${vHref('happy', '#')}"
              ...
              <span class="variant-label">굿뉴스</span>
            </a>` : ''}`;
      })()}</div>
          <span class="logo">KVD MONITOR</span><span class="version">v${__APP_VERSION__}</span>${BETA_MODE ? '<span class="beta-badge">BETA</span>' : ''}
          <a href="https://www.koreavendordata.com" target="_blank" rel="noopener" class="credit-link">
            <span class="credit-text" style="font-size:11px;opacity:.7">Powered by 한국벤더데이터</span>
          </a>
